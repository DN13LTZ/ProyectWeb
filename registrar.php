                ...
                <div class="container-fluid">
                    ...
                    <div class="card o-hidden border-0 shadow-lg my-5">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="p-5">
                                    <form class="user" action="producto.php" method="POST">
                                        ...
                                        <div class="form-group">
                                            <input type="text" class="form-control form-control-user"
                                                id="exampleInputText" placeholder="Descrpción del Producto" 
                                                name="descripcion" required>
                                        </div>
                                        <div class="form-group row">
                                            <div class="col-sm-6 mb-3 mb-sm-0">
                                                <input type="text" class="form-control form-control-user"
                                                    id="exampleInputText" placeholder="Precio" 
                                                    name="precio" required>
                                            </div>
                                            <div class="col-sm-6 mb-3 mb-sm-0x">
                                                <input type="number" class="form-control form-control-user"
                                                    id="exampleInputNumber" placeholder="Cantidad" 
                                                    name="stock" required>
                                            </div>
                                        </div>
                                        <button type="submit"
